  ...
  return (
    <main className="flex flex-col items-center justify-center w-full flex-1 text-center">
      <div className="flex flex-col items-center justify-center w-full flex-1 text-center">
        <div className="flex flex-col items-center justify-center my-20 flex-1 text-center px-20">
          <h1 className="my-10 text-center font-extrabold tracking-[-0.02em] py-4 text-6xl lg:text-8xl text-transparent bg-clip-text bg-gradient-to-tr from-zinc-900 to-zinc-900/90">
            ...
            {Object.keys(articles).map((key, index) => {
              return (
                <div
                  ...
                  key={articles[key].title.split(" ")[0]}
                >
                  <Link href={articles[key].link}>
                    <div className="grid grid-cols-3 h-full">
                      ...
                      <div className="col-span-2 px-4 flex flex-col text-start">
                        <h2 className="text-xl font-bold ">
                          {articles[key].title.split(" ").slice(0, 8).join(" ")}
                        </h2>
