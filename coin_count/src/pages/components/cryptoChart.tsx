      ...
      <div>
        ...
        >
          <Tab
            ...
            key="1M"
            title={<button onClick={() => setTimeFilter("1M")}>1 Month</button>}
          />
          <Tab
            onClick={() => setTimeFilter("1w")}
            key="1w"
            title={<button onClick={() => setTimeFilter("1w")}>1 Week</button>}
          />
          <Tab
            onClick={() => setTimeFilter("1d")}
            key="1d"
            title={<button onClick={() => setTimeFilter("1d")}>1 Day</button>}
          />
        </Tabs>
      </div>
    </div>
