...
import { EyeIcon } from "../components/adminTable/icons/EyeIcon";
import { EditIcon } from "../components/adminTable/icons/EditIcon";
import { DeleteIcon } from "../components/adminTable/icons/DeleteIcon";
               ...
               <Table aria-label="Crypto Data Table"
                ...
                classNames={{
                  ...
                  color="primary">
                    ...
                    <TableBody>
                         {items.map((item: { id: React.Key | null | undefined; rank: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.PromiseLikeOfReactNode | null | undefined; name: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.PromiseLikeOfReactNode | null | undefined; symbol: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.PromiseLikeOfReactNode | null | undefined; priceUsd: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.PromiseLikeOfReactNode | null | undefined; marketCapUsd: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.PromiseLikeOfReactNode | null | undefined; }) => (
                              <TableRow key={item.id}
                              onClick={() => router.push(`/crypto/${item.id}`)} // Add click event to navigate
